...
module.exports = {
  ...
  activate () {
    ...
    this.subscriptions.add(atom.commands.add('atom-workspace',
      {'anki-atom:exportList': () => this.exportList()})
    )
  ...
  //function for making cards of long lists
  //first item is treated as heading
  exportList(){
    const fs = require('fs');
		const editor = atom.workspace.getActiveTextEditor();
		const listItems = editor.getSelectedText().split("\n");
    if(listItems.length>2){
      editor.insertText('<!----------CARD---------->\n<hr><h3>[Text]</h3>\n<b>'+listItems[0]+'</b><br>\n<ol><li>{{c::'+listItems[1]+'}}</li>\n</ol>\n\n<h3>[Extra]</h3>\n\n<h3>[Source]</h3>\n\n<h3>[Tags]</h3>\n\n<hr>\n<!----------/CARD---------->\n')
    }
    for (var i = 1; i < listItems.length-1; i++) {
      editor.insertText('<!----------CARD---------->\n<hr><h3>[Text]</h3>\n<b>'+listItems[0]+'</b><br>\n<ul>\n<li>...</li>\n<li>'+listItems[i]+'</li>\n<li>{{c::'+listItems[i+1]+'}}</li>\n<li>...</li>\n</ul>\n\n<h3>[Extra]</h3>\n\n<h3>[Source]</h3>\n\n<h3>[Tags]</h3>\n\n<hr>\n<!----------/CARD---------->\n')
    }
  },
